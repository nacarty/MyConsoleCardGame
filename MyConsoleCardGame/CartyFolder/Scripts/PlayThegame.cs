...
{
	public class PlayTheGame:CardPack
	{
		int TheWinner;

		public PlayTheGame (int NumPlayers, int NumCards)
		{
		...
		public void PlayTurn(int WhoseTurn, 
			Card[] Array1 , Card[] Array2, Card[] Array3, Card[] Array4 )
		{

			Card Card1, Card2, Card3, Card4; //Card from a Card arrays possibly null

			Random r = new Random (); // r is declared a random number generator
			...
			if (Count > 100) // if no card to play found, exit the function
			{ 
				Console.WriteLine ("First player has made 100 tries to find a card to play without success...");
				Console.WriteLine ("Then somthing must be wrong. Perhaps he should have one already...Check your code.....");
